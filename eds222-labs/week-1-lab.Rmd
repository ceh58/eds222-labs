...
rootdir <- "~/MEDS/EDS-222-stats/eds222-labs"
...
loans_table <- loans %>%
  ...
  tally() %>% # automatically calculates sums
  spread(key = homeownership, value = n) %>% # spread three levels of homeownership into sums of application type
  ungroup() %>%
...
```{r}
# Transform our table into an output for rmd, will be able to see the table in outputted/knitted file
loans_table %>%
